...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      moveSelectedLabel: 'Przenieś wybrane',
      moveAllLabel: 'Przenieś wszystkie',
      removeSelectedLabel: 'Usuń wybrane',
      ...
      infoText: 'Pokazuję: {0}',                                                        // text when all options are visible / false for no info text
      ...
      infoTextEmpty: 'Nic nie wybrano',                                                        // when there are no options present in the list
      ...
      btnClass: 'btn-outline-secondary py-0',                                                  // sets the button style class for all the buttons
