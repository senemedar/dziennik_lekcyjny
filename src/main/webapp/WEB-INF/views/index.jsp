...
<!--  </div>-->
  ...
  <footer class="main-footer ml-0" style="background-color: #fcf8e3">
    <span>Stworzone przez <strong>senemedar</strong>, <strong>pabd9009</strong>, <strong>William Wright</strong>, na podstawie <a href="http://adminlte.io">AdminLTE.io</a>.</span>
